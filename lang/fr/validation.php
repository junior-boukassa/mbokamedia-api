...
|--------------------------------------------------------------------------
|
| `APP_LOCALE=fr` sans ce fichier faisait remonter la clé brute au client :
| l'application mobile affichait « validation.email » sous le champ, ce qui
| passait pour une panne. Toutes les règles du framework sont couvertes.
|
*/
...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Sans cela, « Le champ email est obligatoire » affiche le nom technique.
    |
    */

    'attributes' => [
        'app_version' => 'version de l’application',
        'article_title' => 'titre de l’annonce',
